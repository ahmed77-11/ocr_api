...
regions_rel = {
    ...
    "date_due":          (229/836, 71/540, 383/836, 100/540),  # Tightened to reduce noise
...
for line in ocr_result:
    box, (text, score) = line
    if score < 0.6:  # Skip low-confidence
        continue
...
def clean_text(text, field):
    ...
    if field == "amount_digits":
        ...
        text = text.replace("0ct", "Oct").replace("O", "0").replace("l", "1")
